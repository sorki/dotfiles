...
fu! s:SeeTab()
  ...
  if !exists("g:SeeTabEnabled")
   ...
   if &et
    ...
    set list
    set listchars=tab:\|\ 
"    exe 'silent! hi SpecialKey cterm=underline gui=reverse ctermfg='.g:SeeTabCtermBG.' ctermbg='.g:SeeTabCtermFG.' guifg='.g:SeeTabGuiBG.' guibg=.'g:SeeTabGuiFG
"    exe 'silent! hi SpecialKey ctermfg='.g:SeeTabCtermBG.' ctermbg='.g:SeeTabCtermFG.'' 
    exe 'silent! hi SpecialKey ctermfg='.g:SeeTabCtermFG 
    endif
...
nnoremap <Leader>t :call <SID>SeeTab()<CR>
" ---------------------------------------------------------------------
