...
"mappings
au FileType python,man map <buffer> <leader>p :call ShowPyDoc('<C-R><C-W>', 1)<CR>
au FileType python,man map <buffer> <leader>ps :call ShowPyDoc('<C-R><C-W>', 0)<CR>
map <leader>pc :bd pydoc<CR>
